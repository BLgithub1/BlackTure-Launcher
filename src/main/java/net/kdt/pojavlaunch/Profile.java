...
{
	private static String PROFILE_PREF = "obvilion_profile";
	...
	public static boolean isFileType(Context ctx) {
		return new File(Tools.DIR_ACCOUNT_NEW + "/" + Profile.getCurrentProfileName(ctx) + ".json").exists();
	}
	

    public static void launch(Activity ctx, Object o) {
        Profile.setCurrentProfile(ctx, o);
